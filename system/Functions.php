...
function getMiscallReport(){
    ...
    $allCdrRecodrs = $cdrdb->select("src , uniqueid, calldate, did  FROM cdr WHERE LIKE  '%9889557998%' AND calldate>'".$days4."' AND  disposition = 'NO ANSWER' ORDER BY `calldate`, `uniqueid` ASC ");
